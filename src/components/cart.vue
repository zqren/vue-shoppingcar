<template>
	<div class="cart col-md-offset-2 col-sm-offset-2 col-md-8">
		<div class="panel panel-danger" 
			...
			<div class="panel-body cart-deatil">
				<ul>
					<li v-for="(item,index) in cartProducts">
						<span class="pomegranage glyphicon glyphicon-remove-circle"
            		    ...
            		    <span class="cart-price pomegranage pull-right">
		...
		computed:{
			totalPrice(){
				...
				for(let i in this.cartProducts){
					totalPrice += this.cartProducts[i].price
				}
				return totalPrice
			},
